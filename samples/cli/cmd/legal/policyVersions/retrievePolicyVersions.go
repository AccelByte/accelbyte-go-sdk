...
func init() {
	RetrievePolicyVersionsCmd.Flags().String("basePolicyId", "", "Base policy id")
	RetrievePolicyVersionsCmd.Flags().String("localeId", "", "Locale id")
	RetrievePolicyVersionsCmd.Flags().String("namespace", "", "Namespace")
}
