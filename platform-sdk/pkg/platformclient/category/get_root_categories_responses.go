...
func (o *GetRootCategoriesOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/categories][%d] getRootCategoriesOK  %+v", 200, o.ToString())
}

func (o *GetRootCategoriesOK) ToString() string {
