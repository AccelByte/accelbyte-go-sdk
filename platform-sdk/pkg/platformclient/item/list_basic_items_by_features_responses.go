...
func (o *ListBasicItemsByFeaturesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/items/byFeatures/basic returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ListBasicItemsByFeaturesOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/items/byFeatures/basic][%d] listBasicItemsByFeaturesOK  %+v", 200, o.Payload)
}
