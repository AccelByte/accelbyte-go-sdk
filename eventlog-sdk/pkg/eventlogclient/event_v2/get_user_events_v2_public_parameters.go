...
func (o *GetUserEventsV2PublicParams) WithOffset(offset *float64) *GetUserEventsV2PublicParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get user events v2 public params
func (o *GetUserEventsV2PublicParams) SetOffset(offset *float64) {
	o.Offset = offset
}

// WithPageSize adds the pageSize to the get user events v2 public params
func (o *GetUserEventsV2PublicParams) WithPageSize(pageSize *float64) *GetUserEventsV2PublicParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the get user events v2 public params
func (o *GetUserEventsV2PublicParams) SetPageSize(pageSize *float64) {
	o.PageSize = pageSize
}
