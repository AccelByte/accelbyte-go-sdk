...
for the delete i a p item config operation typically these are written to a http.Request
*/
...
// SetHTTPClient adds the HTTPClient Transport to the delete i a p item config params
