...
func (o *GetSteamIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/steam][%d] getSteamIAPConfigOK  %+v", 200, o.ToString())
}

func (o *GetSteamIAPConfigOK) ToString() string {
