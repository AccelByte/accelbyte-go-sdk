...
samples/cli/sample-apps Lobby userRequestFriend \
    --namespace $AB_NAMESPACE \
    --body '{"friendId": "rwK6Q2fG", "friendPublicId": "tHjoCVMz"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby addFriendsWithoutConfirmation \
    --namespace $AB_NAMESPACE \
    --userId 'aUTViH5E' \
    --body '{"friendIds": ["m3CwELbl", "jBDyhNS2", "g77e65mm"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateConfigV1 \
    --namespace $AB_NAMESPACE \
    --body '{"allowInviteNonConnectedUser": true, "allowJoinPartyDuringMatchmaking": false, "autoKickOnDisconnect": false, "autoKickOnDisconnectDelay": 74, "cancelTicketOnDisconnect": true, "chatRateLimitBurst": 98, "chatRateLimitDuration": 10, "concurrentUsersLimit": 74, "disableInvitationOnJoinParty": false, "enableChat": false, "entitlementCheck": true, "entitlementItemID": "2vZZ4iae", "generalRateLimitBurst": 24, "generalRateLimitDuration": 1, "keepPresenceActivityOnDisconnect": true, "maxPartyMember": 71, "profanityFilter": false, "readyConsentTimeout": 24}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "3gTS0soT", "topicName": "h8pbhOUn", "userIds": ["npYrNU6m", "JPiQTDtz", "SCg9GtmH"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "Vk6j4gsZ", "topicName": "wx438sVy"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId '1HO1QFXH' \
    --body '{"message": "NT9YaQmK", "topicName": "94je9QN6"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'WdJWfcHV' \
    --body '{"templateContext": {"mteGsdD2": "ttZhGr4I", "RgA9Lv6e": "2jx4LJ1u", "CH6ZGNaJ": "njH315aL"}, "templateLanguage": "YdPkcShC", "templateSlug": "alLb5VwF", "topicName": "g4PKKVgD"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTemplateV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "EVUyLbbO", "templateLanguage": "T08mY8SB", "templateSlug": "fj9f48I4"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"DfAKgAuc": "SE8fwy8G", "FvoAs4qD": "MlFELxHk", "SniVwCwz": "m1apv8eT"}, "templateLanguage": "NX8Oz2uz", "templateSlug": "ZLPTzuLZ", "topicName": "MOogIaYG"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getSingleTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '5e37k453' \
    --templateSlug 'w7ZWBQqF' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'tEyyq29W' \
    --templateSlug '61vzBA87' \
    --body '{"templateContent": "lMXe0XA1"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'mWxDoir1' \
    --templateSlug 'lj4WFUv1' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '9AyxZrTo' \
    --templateSlug 'OEDoaWYw' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTopicV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"description": "SN2S9rTA", "topicName": "3Lj51Ugn"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'fUvWBiFe' \
    --body '{"message": "uaAsY4SM", "topicName": "hWNCryKW"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'jbTaDYjp' \
    --body '{"templateContext": {"g1snBxsi": "byRrpC4l", "AC4k9MmP": "iXnrJA8l", "6iWcdRe9": "cY5En4gN"}, "templateLanguage": "C0EEmxvq", "templateSlug": "jnVaAKCz", "topicName": "DuaTIitI"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'H28h74kt' \
    --body '{"custom_attribute": {"nYWgVHw3": {}, "tUqn9cE3": {}, "1lgyt4vF": {}}, "updatedAt": 92}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminSetPlayerSessionAttribute \
    --namespace $AB_NAMESPACE \
    --userId 'DIapbA15' \
    --body '{"attributes": {"L1TAAEcA": "mJk7XSOK", "fsV1frr9": "xbxq1HcS", "1WoGhcFr": "kFwyJ0J4"}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkBlockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'VeX0psp9' \
    --body '{"listBlockedUserId": ["McwX9JUJ", "vx9isexV", "g0La7T4q"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilterIntoList \
    --list 'jVcLJq5b' \
    --namespace $AB_NAMESPACE \
    --body '{"filter": "Vm3EjxSH", "note": "i3XAT2lj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilters \
    --list 'tv2yz9oe' \
    --namespace $AB_NAMESPACE \
    --body '{"filters": [{"filter": "Cv8UAZ4N", "note": "btVjPAFa"}, {"filter": "jdUT50D1", "note": "QptB0qK1"}, {"filter": "VkhXNfyc", "note": "SHHF7AtZ"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminCreateProfanityList \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": true, "name": "HOlTF6cc"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateProfanityList \
    --list 'yLuG2o1k' \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": true, "isMandatory": true, "newName": "bxaikAcY"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminVerifyMessageProfanityResponse \
    --namespace $AB_NAMESPACE \
    --body '{"message": "m17nWLde", "profanityLevel": "9D1Rkbhh"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publicUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'gsOypIs0' \
    --body '{"custom_attribute": {"EHR2O2x2": {}, "F1qm5RTu": {}, "cu4Un8Ul": {}}, "updatedAt": 50}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotification \
    --namespace $AB_NAMESPACE \
    --body '{"message": "QvoYxlda", "topic": "4alyrO1Q"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"x5ZRIRAo": "GE9Yb0gf", "UbZ54K03": "csebxR50", "6xfWL4g9": "7zBVe0kW"}, "templateLanguage": "MR2sWdc4", "templateSlug": "ov5giShy", "topic": "S24JxmaX"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "vQgdkU2M", "templateLanguage": "60MKHTgI", "templateSlug": "WtQ1hOO3"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'WOYo5Lib' \
    --templateSlug '06VcQk4E' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'T1pFP4nw' \
    --templateSlug 'rdMjndJ1' \
    --body '{"templateContent": "32KRtpoG"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalization \
    --namespace $AB_NAMESPACE \
    --templateLanguage '33wKe3Rs' \
    --templateSlug 'YNm0XAcj' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'laLhVXU3' \
    --templateSlug 'OUCvuGF2' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTopic \
    --namespace $AB_NAMESPACE \
    --body '{"description": "TXWYDFRK", "topic": "oGwMWZQP"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotificationByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'GZRCMG3u' \
    --body '{"message": "MlfEgoqj", "topic": "FarwoJ2l"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplateByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'demI5xiS' \
    --body '{"templateContext": {"RkFcj0nu": "MDjvwUlK", "C7GuuJ6p": "al4f9MuM", "Q90PbVD4": "TTXPXhOG"}, "templateLanguage": "9x5ThdMQ", "templateSlug": "7A4I9sFx", "topic": "GEO9qwAD"}' \
    > test.out 2>&1
