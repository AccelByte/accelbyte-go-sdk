...
func (o *DeleteGroupPublicV1BadRequest) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/public/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupPublicV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteGroupPublicV1Unauthorized) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/public/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupPublicV1Unauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteGroupPublicV1Forbidden) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/public/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupPublicV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteGroupPublicV1NotFound) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/public/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupPublicV1NotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteGroupPublicV1InternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/public/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupPublicV1InternalServerError  %+v", 500, o.Payload)
}
