...
var AdminGetGroupContentsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ok, err := adminGroupService.AdminGetGroupContentsShort(input, nil)
		if err != nil {
			logrus.Error(err)
...
func init() {
	...
	AdminGetGroupContentsCmd.Flags().Int64P("limit", "", 20, "Limit")
	AdminGetGroupContentsCmd.Flags().Int64P("offset", "", 0, "Offset")
}
