...
func (o *SyncXboxInventoryOK) Error() string {
	return fmt.Sprintf("[PUT /platform/public/namespaces/{namespace}/users/{userId}/iap/xbl/sync][%d] syncXboxInventoryOK  %+v", 200, o.ToString())
}

func (o *SyncXboxInventoryOK) ToString() string {
