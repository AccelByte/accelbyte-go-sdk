...
func (o *CheckUserSubscriptionSubscribableByItemIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/users/{userId}/subscriptions/subscribable/byItemId returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *CheckUserSubscriptionSubscribableByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/users/{userId}/subscriptions/subscribable/byItemId][%d] checkUserSubscriptionSubscribableByItemIdOK  %+v", 200, o.Payload)
}
