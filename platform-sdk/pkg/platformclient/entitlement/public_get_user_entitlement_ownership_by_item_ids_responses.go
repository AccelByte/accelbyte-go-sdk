...
func (o *PublicGetUserEntitlementOwnershipByItemIdsOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemIds][%d] publicGetUserEntitlementOwnershipByItemIdsOK  %+v", 200, o.Payload)
}
