...
// IAPConsumeHistoryPagingSlicedResult i a p consume history paging sliced result
//
...
// Validate validates this i a p consume history paging sliced result
...
func (m *IAPConsumeHistoryPagingSlicedResult) validatePaging(formats strfmt.Registry) error {
