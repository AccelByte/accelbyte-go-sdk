...
func (o *LeaveGroupPublicV1OK) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1OK  %+v", 200, o.Payload)
}
...
func (o *LeaveGroupPublicV1BadRequest) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *LeaveGroupPublicV1Unauthorized) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1Unauthorized  %+v", 401, o.Payload)
}
...
func (o *LeaveGroupPublicV1Forbidden) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *LeaveGroupPublicV1NotFound) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1NotFound  %+v", 404, o.Payload)
}
...
func (o *LeaveGroupPublicV1InternalServerError) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/leave][%d] leaveGroupPublicV1InternalServerError  %+v", 500, o.Payload)
}
