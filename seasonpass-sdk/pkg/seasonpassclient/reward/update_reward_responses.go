...
func (o *UpdateRewardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *UpdateRewardOK) Error() string {
	return fmt.Sprintf("[PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}][%d] updateRewardOK  %+v", 200, o.Payload)
}
...
func (o *UpdateRewardBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}][%d] updateRewardBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateRewardNotFound) Error() string {
	return fmt.Sprintf("[PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}][%d] updateRewardNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateRewardConflict) Error() string {
	return fmt.Sprintf("[PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}][%d] updateRewardConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateRewardUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PATCH /admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}][%d] updateRewardUnprocessableEntity  %+v", 422, o.Payload)
}
