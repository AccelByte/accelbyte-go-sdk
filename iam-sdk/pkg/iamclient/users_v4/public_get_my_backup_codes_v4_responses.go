...
func (o *PublicGetMyBackupCodesV4OK) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4OK  %+v", 200, o.ToString())
}

func (o *PublicGetMyBackupCodesV4OK) ToString() string {
...
func (o *PublicGetMyBackupCodesV4BadRequest) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4BadRequest  %+v", 400, o.ToString())
}

func (o *PublicGetMyBackupCodesV4BadRequest) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *PublicGetMyBackupCodesV4Unauthorized) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4Unauthorized  %+v", 401, o.ToString())
}

func (o *PublicGetMyBackupCodesV4Unauthorized) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *PublicGetMyBackupCodesV4Forbidden) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4Forbidden  %+v", 403, o.ToString())
}

func (o *PublicGetMyBackupCodesV4Forbidden) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *PublicGetMyBackupCodesV4NotFound) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4NotFound  %+v", 404, o.ToString())
}

func (o *PublicGetMyBackupCodesV4NotFound) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *PublicGetMyBackupCodesV4InternalServerError) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4InternalServerError  %+v", 500, o.ToString())
}

func (o *PublicGetMyBackupCodesV4InternalServerError) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
