...
func (o *PublicGetMessagesOK) Error() string {
	return fmt.Sprintf("[GET /matchmaking/v1/messages][%d] publicGetMessagesOK  %+v", 200, o.ToString())
}
...
func (o *PublicGetMessagesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /matchmaking/v1/messages][%d] publicGetMessagesInternalServerError  %+v", 500, o.ToString())
}
