...
func (o *PublicGetUserByPlatformUserIDV3OK) Error() string {
	return fmt.Sprintf("[GET /iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}][%d] publicGetUserByPlatformUserIdV3OK  %+v", 200, o.Payload)
}
...
func (o *PublicGetUserByPlatformUserIDV3Unauthorized) Error() string {
	return fmt.Sprintf("[GET /iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}][%d] publicGetUserByPlatformUserIdV3Unauthorized  %+v", 401, o.Payload)
}
...
func (o *PublicGetUserByPlatformUserIDV3Forbidden) Error() string {
	return fmt.Sprintf("[GET /iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}][%d] publicGetUserByPlatformUserIdV3Forbidden  %+v", 403, o.Payload)
}
...
func (o *PublicGetUserByPlatformUserIDV3NotFound) Error() string {
	return fmt.Sprintf("[GET /iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}][%d] publicGetUserByPlatformUserIdV3NotFound  %+v", 404, o.Payload)
}
...
func (o *PublicGetUserByPlatformUserIDV3InternalServerError) Error() string {
	return fmt.Sprintf("[GET /iam/v3/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}][%d] publicGetUserByPlatformUserIdV3InternalServerError  %+v", 500, o.Payload)
}
