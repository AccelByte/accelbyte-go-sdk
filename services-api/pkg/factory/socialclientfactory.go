...
func newCustomSocialHttpClientWithConfig(formats strfmt.Registry, cfg *socialclient.TransportConfig, userAgent, xAmazonTraceId string) *socialclient.JusticeSocialService {
	if cfg == nil {
