...
func (o *UpdatePaymentCallbackConfigOK) Error() string {
	return fmt.Sprintf("[PUT /platform/admin/namespaces/{namespace}/payment/config/callback][%d] updatePaymentCallbackConfigOK  %+v", 200, o.ToString())
}

func (o *UpdatePaymentCallbackConfigOK) ToString() string {
