...
func (o *GetNamespaceSlotConfigOK) Error() string {
	return fmt.Sprintf("[GET /social/admin/namespaces/{namespace}/config][%d] getNamespaceSlotConfigOK  %+v", 200, o.ToString())
}

func (o *GetNamespaceSlotConfigOK) ToString() string {
