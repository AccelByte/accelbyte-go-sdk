...
func (aaa *ConfigurationService) GetListOfSecretsV1(input *configuration.GetListOfSecretsV1Params) (*csmclientmodels.GeneratedGetListOfConfigurationsV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Configuration.GetListOfSecretsV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *ConfigurationService) SaveSecretV1(input *configuration.SaveSecretV1Params) (*csmclientmodels.GeneratedSaveConfigurationV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Configuration.SaveSecretV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigurationService) UpdateSecretV1(input *configuration.UpdateSecretV1Params) (*csmclientmodels.GeneratedUpdateConfigurationV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Configuration.UpdateSecretV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigurationService) DeleteSecretV1(input *configuration.DeleteSecretV1Params) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Configuration.DeleteSecretV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
...
func (aaa *ConfigurationService) GetListOfVariablesV1(input *configuration.GetListOfVariablesV1Params) (*csmclientmodels.GeneratedGetListOfConfigurationsV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Configuration.GetListOfVariablesV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigurationService) SaveVariableV1(input *configuration.SaveVariableV1Params) (*csmclientmodels.GeneratedSaveConfigurationV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Configuration.SaveVariableV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigurationService) UpdateVariableV1(input *configuration.UpdateVariableV1Params) (*csmclientmodels.GeneratedUpdateConfigurationV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Configuration.UpdateVariableV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigurationService) DeleteVariableV1(input *configuration.DeleteVariableV1Params) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Configuration.DeleteVariableV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
