...
// DLCItemConfigInfo d l c item config info
//
...
// Validate validates this d l c item config info
...
func (m *DLCItemConfigInfo) validateData(formats strfmt.Registry) error {
