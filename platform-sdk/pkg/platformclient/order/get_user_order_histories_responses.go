...
func (o *GetUserOrderHistoriesOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history][%d] getUserOrderHistoriesOK  %+v", 200, o.ToString())
}

func (o *GetUserOrderHistoriesOK) ToString() string {
