...
func (o *TestAdyenConfigOK) Error() string {
	return fmt.Sprintf("[POST /platform/admin/payment/config/merchant/adyenconfig/test][%d] testAdyenConfigOK  %+v", 200, o.ToString())
}

func (o *TestAdyenConfigOK) ToString() string {
