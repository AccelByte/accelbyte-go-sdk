...
// SetHTTPClient adds the HTTPClient Transport to the get stadia i a p config params
func (o *GetStadiaIAPConfigParams) SetHTTPClientTransport(roundTripper http.RoundTripper) {
	if o.HTTPClient != nil {
