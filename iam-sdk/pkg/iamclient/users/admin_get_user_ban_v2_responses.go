...
func (o *AdminGetUserBanV2OK) Error() string {
	return fmt.Sprintf("[GET /iam/v2/admin/namespaces/{namespace}/users/{userId}/bans][%d] adminGetUserBanV2OK  %+v", 200, o.ToString())
}

func (o *AdminGetUserBanV2OK) ToString() string {
