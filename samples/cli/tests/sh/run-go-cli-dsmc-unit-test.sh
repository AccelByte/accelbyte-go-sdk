...
#- 11 getAllDeployment
$ sample-apps Dsmc getAllDeployment \
    --namespace 'xxFqmAGT' \
    --count '70' \
    --offset '68' \
    >$TEMP_FILE 2>&1
...
#- 12 getDeployment
$ sample-apps Dsmc getDeployment \
    --deployment 'EdagEtp4' \
    --namespace 'w29KOu9c' \
    >$TEMP_FILE 2>&1
...
#- 13 createDeployment
$ sample-apps Dsmc createDeployment \
...
#- 14 deleteDeployment
$ sample-apps Dsmc deleteDeployment \
    --deployment 'coAAOjKN' \
    --namespace 'jfcYHm09' \
    >$TEMP_FILE 2>&1
...
#- 15 updateDeployment
$ sample-apps Dsmc updateDeployment \
...
$ sample-apps Dsmc createRootRegionOverride \
...
$ sample-apps Dsmc deleteRootRegionOverride \
    --deployment '1YHo9m12' \
    --namespace '6ZWc8hHt' \
    --region 'WvbNYqgU' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc updateRootRegionOverride \
...
$ sample-apps Dsmc createDeploymentOverride \
...
$ sample-apps Dsmc deleteDeploymentOverride \
    --deployment 'pBIcuC1d' \
    --namespace 'QY93OJnJ' \
    --version '6Te9vD8l' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc updateDeploymentOverride \
...
$ sample-apps Dsmc createOverrideRegionOverride \
...
$ sample-apps Dsmc deleteOverrideRegionOverride \
    --deployment 'uauw1xT7' \
    --namespace 'eMwSl9ML' \
    --region 'H0NnTJ2u' \
    --version 'lNzBvwJa' \
...
$ sample-apps Dsmc updateOverrideRegionOverride \
...
#- 25 getAllPodConfig
$ sample-apps Dsmc getAllPodConfig \
    --namespace 'UqvPCZ2H' \
    --count '50' \
    --offset '91' \
    >$TEMP_FILE 2>&1
...
#- 27 createPodConfig
$ sample-apps Dsmc createPodConfig \
...
#- 28 deletePodConfig
$ sample-apps Dsmc deletePodConfig \
    --name 'Jgvg6h5H' \
    --namespace 'IpH0Dvip' \
    >$TEMP_FILE 2>&1
...
#- 29 updatePodConfig
$ sample-apps Dsmc updatePodConfig \
...
#- 36 getImageLimit
$ sample-apps Dsmc getImageLimit \
    --namespace 'q7HJk0F8' \
    >$TEMP_FILE 2>&1
...
#- 37 getImageDetail
$ sample-apps Dsmc getImageDetail \
    --namespace '9xAc3YVf' \
    --version 'aENtrl0p' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc countServerDetailed \
    --namespace 'yMddB41J' \
    --region 'uMf7RUyB' \
    >$TEMP_FILE 2>&1
...
#- 41 listLocalServer
$ sample-apps Dsmc listLocalServer \
    --namespace 'HRj8IiRi' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc deleteLocalServer \
    --name 'mRllHT6D' \
    --namespace 'c40vFFA6' \
    >$TEMP_FILE 2>&1
...
#- 45 getServerLogs
$ sample-apps Dsmc getServerLogs \
    --namespace 'IbuTrrkb' \
    --podName 'muT1whOq' \
    >$TEMP_FILE 2>&1
...
#- 48 deleteSession
$ sample-apps Dsmc deleteSession \
    --namespace '7TZHWDdC' \
    --sessionID 'kIsZoArW' \
    >$TEMP_FILE 2>&1
...
#- 49 exportConfigV1
$ sample-apps Dsmc exportConfigV1 \
    --namespace 'wPHcyFAd' \
    >$TEMP_FILE 2>&1
...
#- 50 importConfigV1
$ sample-apps Dsmc importConfigV1 \
    --file 'tmp.dat' \
    --namespace 'AtYciLIg' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc imageDetailClient \
    --namespace 'RwFRr0gw' \
    --version 'B9tz3vp9' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc deregisterLocalServer \
    --body '{"name": "9XVlV8rK"}' \
    --namespace '3tE6n0sm' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc registerLocalServer \
...
#- 54 registerServer
$ sample-apps Dsmc registerServer \
...
#- 55 shutdownServer
$ sample-apps Dsmc shutdownServer \
...
#- 56 getServerSession
$ sample-apps Dsmc getServerSession \
    --namespace 'dAasm8xw' \
    --podName 'UfzOlQiZ' \
    >$TEMP_FILE 2>&1
...
#- 57 createSession
$ sample-apps Dsmc createSession \
...
$ sample-apps Dsmc getDefaultProvider \
    >$TEMP_FILE 2>&1
update_status $? 'getDefaultProvider'
delete_file $TEMP_FILE

#- 61 listProviders
$ sample-apps Dsmc listProviders \
    >$TEMP_FILE 2>&1
update_status $? 'listProviders'
delete_file $TEMP_FILE

#- 62 listProvidersByRegion
$ sample-apps Dsmc listProvidersByRegion \
    --region 'EklkzLm8' \
    >$TEMP_FILE 2>&1
...
$ sample-apps Dsmc publicGetMessages \
    >$TEMP_FILE 2>&1
