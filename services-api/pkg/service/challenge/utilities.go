...
// Deprecated: 2022-01-10 - please use AdminGetItemReferencesShort instead.
func (aaa *UtilitiesService) AdminGetItemReferences(input *utilities.AdminGetItemReferencesParams) (*challengeclientmodels.ModelItemReferenceResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Utilities.AdminGetItemReferences(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *UtilitiesService) AdminGetItemReferencesShort(input *utilities.AdminGetItemReferencesParams) (*challengeclientmodels.ModelItemReferenceResponse, error) {
