...
func init() {
	...
	LobbyCmd.AddCommand(friends.AdminListFriendsOfFriendsCmd)
	...
	LobbyCmd.AddCommand(player.AdminBulkUnblockPlayersV1Cmd)
	...
	LobbyCmd.AddCommand(player.PublicPlayerBlockPlayersV1Cmd)
