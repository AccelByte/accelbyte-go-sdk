...
func (o *RetrieveEligibilitiesPublicIndirectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /public/eligibilities/namespaces/{namespace}/countries/{countryCode}/clients/{clientId}/users/{userId} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *RetrieveEligibilitiesPublicIndirectOK) Error() string {
	return fmt.Sprintf("[GET /public/eligibilities/namespaces/{namespace}/countries/{countryCode}/clients/{clientId}/users/{userId}][%d] retrieveEligibilitiesPublicIndirectOK  %+v", 200, o.Payload)
}
