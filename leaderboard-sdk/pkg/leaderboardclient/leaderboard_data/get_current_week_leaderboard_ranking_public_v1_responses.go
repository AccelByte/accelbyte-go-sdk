...
func (o *GetCurrentWeekLeaderboardRankingPublicV1OK) Error() string {
	return fmt.Sprintf("[GET /leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/week][%d] getCurrentWeekLeaderboardRankingPublicV1OK  %+v", 200, o.ToString())
}

func (o *GetCurrentWeekLeaderboardRankingPublicV1OK) ToString() string {
...
func (o *GetCurrentWeekLeaderboardRankingPublicV1BadRequest) Error() string {
	return fmt.Sprintf("[GET /leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/week][%d] getCurrentWeekLeaderboardRankingPublicV1BadRequest  %+v", 400, o.ToString())
}

func (o *GetCurrentWeekLeaderboardRankingPublicV1BadRequest) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *GetCurrentWeekLeaderboardRankingPublicV1NotFound) Error() string {
	return fmt.Sprintf("[GET /leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/week][%d] getCurrentWeekLeaderboardRankingPublicV1NotFound  %+v", 404, o.ToString())
}

func (o *GetCurrentWeekLeaderboardRankingPublicV1NotFound) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
...
func (o *GetCurrentWeekLeaderboardRankingPublicV1InternalServerError) Error() string {
	return fmt.Sprintf("[GET /leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/week][%d] getCurrentWeekLeaderboardRankingPublicV1InternalServerError  %+v", 500, o.ToString())
}

func (o *GetCurrentWeekLeaderboardRankingPublicV1InternalServerError) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
