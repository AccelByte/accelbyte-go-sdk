...
func (o *PublicGetQRCodeOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/payment/qrcode][%d] publicGetQRCodeOK  %+v", 200, o.ToString())
}

func (o *PublicGetQRCodeOK) ToString() string {
