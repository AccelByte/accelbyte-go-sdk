...
func (o *QueryUserEntitlementsByAppTypeOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byAppType][%d] queryUserEntitlementsByAppTypeOK  %+v", 200, o.ToString())
}

func (o *QueryUserEntitlementsByAppTypeOK) ToString() string {
