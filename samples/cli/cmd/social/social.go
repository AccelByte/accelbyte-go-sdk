...
func init() {
	...
	SocialCmd.AddCommand(statCycleConfiguration.BulkGetStatCycleCmd)
	SocialCmd.AddCommand(statCycleConfiguration.ExportStatCycleCmd)
	SocialCmd.AddCommand(statCycleConfiguration.ImportStatCycleCmd)
	...
	SocialCmd.AddCommand(userStatistic.BulkFetchOrDefaultStatItemsCmd)
	...
	SocialCmd.AddCommand(statCycleConfiguration.BulkGetStatCycle1Cmd)
	...
	SocialCmd.AddCommand(userStatisticCycle.PublicListMyStatCycleItemsCmd)
	SocialCmd.AddCommand(userStatistic.PublicListMyStatItemsCmd)
	SocialCmd.AddCommand(userStatistic.PublicListAllMyStatItemsCmd)
	...
	SocialCmd.AddCommand(userStatistic.BulkGetOrDefaultByUserIdCmd)
	...
	SocialCmd.AddCommand(userStatistic.PublicQueryUserStatItems2Cmd)
