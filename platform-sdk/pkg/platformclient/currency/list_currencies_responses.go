...
func (o *ListCurrenciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/currencies returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ListCurrenciesOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/currencies][%d] listCurrenciesOK  %+v", 200, o.Payload)
}
