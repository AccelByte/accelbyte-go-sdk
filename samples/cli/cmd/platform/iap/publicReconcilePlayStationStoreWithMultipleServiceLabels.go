...
var PublicReconcilePlayStationStoreWithMultipleServiceLabelsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		input := &i_a_p.PublicReconcilePlayStationStoreWithMultipleServiceLabelsParams{
			Body:      body,
			Namespace: namespace,
			UserID:    userId,
		}
		errInput := iapService.PublicReconcilePlayStationStoreWithMultipleServiceLabelsShort(input)
		if errInput != nil {
