...
func (o *GetGameRecordHandlerByKeyV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetGameRecordHandlerByKeyV1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewGetGameRecordHandlerByKeyV1InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetGameRecordHandlerByKeyV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetGameRecordHandlerByKeyV1OK() *GetGameRecordHandlerByKeyV1OK {
	return &GetGameRecordHandlerByKeyV1OK{}
}
...
func (o *GetGameRecordHandlerByKeyV1OK) Error() string {
	return fmt.Sprintf("[GET /cloudsave/v1/admin/namespaces/{namespace}/records/{key}][%d] getGameRecordHandlerByKeyV1OK  %+v", 200, o.Payload)
}
...
func (o *GetGameRecordHandlerByKeyV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetGameRecordHandlerByKeyV1InternalServerError() *GetGameRecordHandlerByKeyV1InternalServerError {
	return &GetGameRecordHandlerByKeyV1InternalServerError{}
}
...
func (o *GetGameRecordHandlerByKeyV1InternalServerError) Error() string {
	return fmt.Sprintf("[GET /cloudsave/v1/admin/namespaces/{namespace}/records/{key}][%d] getGameRecordHandlerByKeyV1InternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetGameRecordHandlerByKeyV1InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetGameRecordHandlerByKeyV1Default(code int) *GetGameRecordHandlerByKeyV1Default {
	return &GetGameRecordHandlerByKeyV1Default{
		_statusCode: code,
	}
}
...
func (o *GetGameRecordHandlerByKeyV1Default) Error() string {
	return fmt.Sprintf("[GET /cloudsave/v1/admin/namespaces/{namespace}/records/{key}][%d] getGameRecordHandlerByKeyV1 default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetGameRecordHandlerByKeyV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
