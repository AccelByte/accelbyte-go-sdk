...
//
// swagger:model IAPItemFlatEntry
...
func (m *IAPItemFlatEntry) validateItemIdentityType(formats strfmt.Registry) error {
...
func (m *IAPItemFlatEntry) validatePlatform(formats strfmt.Registry) error {
