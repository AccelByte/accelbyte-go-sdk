...
samples/cli/sample-apps Gdpr adminGetListDeletionDataRequest \
    ...
    --after 'Cm2Q5VXN9U3hytw7' \
    --before 'RiKmxoh5wrkumFfT' \
    --limit '2' \
    --offset '64' \
    --requestDate 'xg4E5lngV7GMKjTT' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr updateAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["ufeIsokme4gVS5zB", "YH2uRFbwAosm73Yv", "IxgYkNuAUD7h154M"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr saveAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["mRiOGm5lAkRpbBe6", "mz9tovFoiQyJT3pt", "bJt4X8ta0QJpJynj"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr deleteAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --emails '["rINOBwbzSG7R5vUW", "EzepTwPtMPygK7iV", "klT4ufGlO8JCIY8O"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdateServicesConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"services": [{"extendConfig": {"appName": "3VGgVGeubhbcm3rd", "namespace": "D1JhJmVcXGuoTEpv"}, "id": "QMF0rEYKTuGqyk60", "serviceConfig": {"protocol": "GRPC", "url": "QZ7DN8IF9gZVm2JO"}, "type": "EXTEND"}, {"extendConfig": {"appName": "emmo1gu7FpKb9TwZ", "namespace": "CJfBICqH2gspo9Lf"}, "id": "k6pIEF0YUgVCvkKS", "serviceConfig": {"protocol": "GRPC", "url": "Go9iE9xzdUeWulQe"}, "type": "SERVICE"}, {"extendConfig": {"appName": "7okc9LjZ12SUlc8R", "namespace": "6DEYla27BjOdoNlh"}, "id": "xewB7pBG9faqO46w", "serviceConfig": {"protocol": "GRPC", "url": "jOvRytXkoIOS35oR"}, "type": "EXTEND"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminRequestDataRetrieval \
    --namespace $AB_NAMESPACE \
    --userId 'rAUZNVaE06NAcc6e' \
    --password '6z8VWJ5FpNYtNW95' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminCancelUserPersonalDataRequest \
    --namespace $AB_NAMESPACE \
    --requestDate 'KOafkgLfgFk6zXUH' \
    --userId 'CpmI9ehMdzypuM35' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminGeneratePersonalDataURL \
    --namespace $AB_NAMESPACE \
    --requestDate 'vzjYV2wUJSOqbFDw' \
    --userId '8UFdvZx1InMddCsv' \
    --password 'yuP3jAJ9EXQem5kF' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicSubmitUserAccountDeletionRequest \
    --namespace $AB_NAMESPACE \
    --userId 'p8W46eI4etWguOR9' \
    --password 'OT5kXdmcyEtGjkN5' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicRequestDataRetrieval \
    --namespace $AB_NAMESPACE \
    --userId '5ignkrBYu6GM7seM' \
    --password 'FQQYsvQjkrRrSH9s' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicCancelUserPersonalDataRequest \
    --namespace $AB_NAMESPACE \
    --requestDate 'ZHlDOZlBS3zpjcEZ' \
    --userId 'cGDA2Ao5Yr71o7kk' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicGeneratePersonalDataURL \
    --namespace $AB_NAMESPACE \
    --requestDate 'rRfCHVW0rJlqvnSu' \
    --userId 'vVLtch62r2N3paRj' \
    --password '1flT5HnayshIfANc' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicSubmitMyAccountDeletionRequest \
    --platformId 'MquYBuxjpEQt40Ts' \
    --platformToken '7QQpboARZfghuOjP' \
    > test.out 2>&1
