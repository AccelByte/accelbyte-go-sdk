...
func (o *CreateClientByNamespaceCreated) Error() string {
	return fmt.Sprintf("[POST /iam/namespaces/{namespace}/clients][%d] createClientByNamespaceCreated  %+v", 201, o.ToString())
}

func (o *CreateClientByNamespaceCreated) ToString() string {
