...
/*PublicDisableMyAuthenticatorV4BadRequest handles this case with default header values.
  ...
  <table><tr><td>errorCode</td><td>errorMessage</td></tr><tr><td>10191</td><td>email address not verified</td></tr></table>
*/
...
func (o *PublicDisableMyAuthenticatorV4BadRequest) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable][%d] publicDisableMyAuthenticatorV4BadRequest  %+v", 400, o.Payload)
}
...
func (o *PublicDisableMyAuthenticatorV4Unauthorized) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable][%d] publicDisableMyAuthenticatorV4Unauthorized  %+v", 401, o.Payload)
}
...
func (o *PublicDisableMyAuthenticatorV4Forbidden) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable][%d] publicDisableMyAuthenticatorV4Forbidden  %+v", 403, o.Payload)
}
...
func (o *PublicDisableMyAuthenticatorV4NotFound) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable][%d] publicDisableMyAuthenticatorV4NotFound  %+v", 404, o.Payload)
}
...
func (o *PublicDisableMyAuthenticatorV4InternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable][%d] publicDisableMyAuthenticatorV4InternalServerError  %+v", 500, o.Payload)
}
