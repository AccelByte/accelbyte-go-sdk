...
func (o *TestStripeConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested POST /admin/payment/config/merchant/stripeconfig/test returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *TestStripeConfigOK) Error() string {
	return fmt.Sprintf("[POST /admin/payment/config/merchant/stripeconfig/test][%d] testStripeConfigOK  %+v", 200, o.Payload)
}
