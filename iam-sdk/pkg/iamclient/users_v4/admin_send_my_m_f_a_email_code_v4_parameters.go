...
for the admin send my m f a email code v4 operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) WithTimeout(timeout time.Duration) *AdminSendMyMFAEmailCodeV4Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) WithContext(ctx context.Context) *AdminSendMyMFAEmailCodeV4Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// SetAuthInfoWriter adds the authInfoWriter to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) SetAuthInfoWriter(authInfoWriter runtime.ClientAuthInfoWriter) {
	o.AuthInfoWriter = authInfoWriter
}

// WithHTTPClient adds the HTTPClient to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) WithHTTPClient(client *http.Client) *AdminSendMyMFAEmailCodeV4Params {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the admin send my m f a email code v4 params
func (o *AdminSendMyMFAEmailCodeV4Params) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// SetHTTPClient adds the HTTPClient Transport to the admin send my m f a email code v4 params
