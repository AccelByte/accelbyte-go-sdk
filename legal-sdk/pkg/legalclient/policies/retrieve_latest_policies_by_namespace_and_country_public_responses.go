...
func (o *RetrieveLatestPoliciesByNamespaceAndCountryPublicOK) Error() string {
	return fmt.Sprintf("[GET /agreement/public/policies/namespaces/{namespace}/countries/{countryCode}][%d] retrieveLatestPoliciesByNamespaceAndCountryPublicOK  %+v", 200, o.ToString())
}

func (o *RetrieveLatestPoliciesByNamespaceAndCountryPublicOK) ToString() string {
