...
// DLCItemConfigUpdate d l c item config update
//
...
// Validate validates this d l c item config update
...
func (m *DLCItemConfigUpdate) validateData(formats strfmt.Registry) error {
