...
func (o *PublicQueryUserEntitlementsOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements][%d] publicQueryUserEntitlementsOK  %+v", 200, o.ToString())
}

func (o *PublicQueryUserEntitlementsOK) ToString() string {
