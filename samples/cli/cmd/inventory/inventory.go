...
func init() {
	...
	InventoryCmd.AddCommand(adminItems.AdminBulkSaveItemToInventoryCmd)
	InventoryCmd.AddCommand(adminInventories.AdminUpdateUserInventoriesByInventoryCodeCmd)
	InventoryCmd.AddCommand(adminItems.AdminSaveItemCmd)
	InventoryCmd.AddCommand(adminItems.AdminBulkSaveItemCmd)
