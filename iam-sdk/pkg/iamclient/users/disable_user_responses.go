...
func (o *DisableUserUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /iam/namespaces/{namespace}/users/{userId}/disable][%d] disableUserUnauthorized ", 401)
}
...
func (o *DisableUserForbidden) Error() string {
	return fmt.Sprintf("[PUT /iam/namespaces/{namespace}/users/{userId}/disable][%d] disableUserForbidden ", 403)
}
