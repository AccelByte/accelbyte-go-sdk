...
samples/cli/sample-apps Gdpr adminGetListDeletionDataRequest \
    ...
    --after '9wPBrAtreyB2Iuzb' \
    --before 'SYGDMzJjCMXQdEMG' \
    --limit '60' \
    --offset '70' \
    --requestDate 'ZZUDs3UMjc0gYX1S' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr updateAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["XAyWHUEaEWDgSOhZ", "XhPR1vDnSOzNMgFE", "5U8Ovc6CliOsNcCd"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr saveAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["FzAroG9IWxhSLfcC", "LWpX2wUlPDJgU0iU", "nvY01I2RUXxLTaIj"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr deleteAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --emails '["8Win50zSUdINwqzT", "ZDC8MkXb74jimdOz", "4mXp1ApDKGCuVibc"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminRequestDataRetrieval \
    --namespace $AB_NAMESPACE \
    --userId 'ifJMxenWY0b1SMTD' \
    --password 'BbbZxtkJDX5K8iNR' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminCancelUserPersonalDataRequest \
    --namespace $AB_NAMESPACE \
    --requestDate '43xc5jRJZs7KRspl' \
    --userId 'GK3FgYtWw3kJXy2G' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminGeneratePersonalDataURL \
    --namespace $AB_NAMESPACE \
    --requestDate 'HtZPglyjGwtvGU0E' \
    --userId 'VpCiMd4QPWXeCHuy' \
    --password 'qkBqNyi2dnaWcxy5' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicSubmitUserAccountDeletionRequest \
    --namespace $AB_NAMESPACE \
    --userId 'kcfAKxQ3Eb69YG16' \
    --password 'jpKAoTSW7ejN83SU' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicRequestDataRetrieval \
    --namespace $AB_NAMESPACE \
    --userId '9uNQlZDKSlkKvekd' \
    --password 'MuTSvlb2kPH1YUyY' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicCancelUserPersonalDataRequest \
    --namespace $AB_NAMESPACE \
    --requestDate '1jiYIZ5qlpgvpMAz' \
    --userId 'Ht5thNI4QmDCmNBD' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr publicGeneratePersonalDataURL \
    --namespace $AB_NAMESPACE \
    --requestDate 'OvolL1d4XZc2bSAu' \
    --userId 'k4olIGhvaO3uHdiz' \
    --password 'UwFgu2g6oTuRKZoE' \
    > test.out 2>&1
