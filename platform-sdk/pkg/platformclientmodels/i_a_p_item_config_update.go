...
// IAPItemConfigUpdate i a p item config update
//
...
// Validate validates this i a p item config update
...
func (m *IAPItemConfigUpdate) validateData(formats strfmt.Registry) error {
