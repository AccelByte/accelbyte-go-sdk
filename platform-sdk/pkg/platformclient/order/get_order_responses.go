...
func (o *GetOrderOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/orders/{orderNo}][%d] getOrderOK  %+v", 200, o.ToString())
}

func (o *GetOrderOK) ToString() string {
...
func (o *GetOrderNotFound) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/orders/{orderNo}][%d] getOrderNotFound  %+v", 404, o.ToString())
}

func (o *GetOrderNotFound) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
