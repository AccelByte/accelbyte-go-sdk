...
for the send m f a authentication code operation typically these are written to a http.Request
*/
...
// WithClientID adds the clientID to the send m f a authentication code params
func (o *SendMFAAuthenticationCodeParams) WithClientID(clientID string) *SendMFAAuthenticationCodeParams {
	o.SetClientID(clientID)
	return o
}

// SetClientID adds the clientId to the send m f a authentication code params
func (o *SendMFAAuthenticationCodeParams) SetClientID(clientID string) {
	o.ClientID = clientID
}

// WithFactor adds the factor to the send m f a authentication code params
func (o *SendMFAAuthenticationCodeParams) WithFactor(factor string) *SendMFAAuthenticationCodeParams {
	o.SetFactor(factor)
	return o
}

// SetFactor adds the factor to the send m f a authentication code params
func (o *SendMFAAuthenticationCodeParams) SetFactor(factor string) {
	o.Factor = factor
}

// WithMfaToken adds the mfaToken to the send m f a authentication code params
...
// SetMfaToken adds the mfaToken to the send m f a authentication code params
