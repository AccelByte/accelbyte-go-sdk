...
func (o *GetSingleTemplateLocalizationV1AdminReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetSingleTemplateLocalizationV1AdminOK) Error() string {
	return fmt.Sprintf("[GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}][%d] getSingleTemplateLocalizationV1AdminOK  %+v", 200, o.Payload)
}
...
func (o *GetSingleTemplateLocalizationV1AdminUnauthorized) Error() string {
	return fmt.Sprintf("[GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}][%d] getSingleTemplateLocalizationV1AdminUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetSingleTemplateLocalizationV1AdminForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}][%d] getSingleTemplateLocalizationV1AdminForbidden  %+v", 403, o.Payload)
}
...
func (o *GetSingleTemplateLocalizationV1AdminNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}][%d] getSingleTemplateLocalizationV1AdminNotFound  %+v", 404, o.Payload)
}
...
func (o *GetSingleTemplateLocalizationV1AdminInternalServerError) Error() string {
	return fmt.Sprintf("[GET /v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}/languages/{templateLanguage}][%d] getSingleTemplateLocalizationV1AdminInternalServerError  %+v", 500, o.Payload)
}
