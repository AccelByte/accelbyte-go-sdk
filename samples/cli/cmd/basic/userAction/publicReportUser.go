...
func init() {
	...
	publicReportUserCmd.Flags().StringP("body", "b", " ", "Body")
	publicReportUserCmd.Flags().StringP("namespace", "n", " ", "Namespace")
	_ = publicReportUserCmd.MarkFlagRequired("namespace")
	publicReportUserCmd.Flags().StringP("userId", "u", " ", "User id")
