...
samples/cli/sample-apps Lobby userRequestFriend \
    --namespace $AB_NAMESPACE \
    --body '{"friendId": "AE8tyxgG", "friendPublicId": "8Ye3GoJI"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby addFriendsWithoutConfirmation \
    --namespace $AB_NAMESPACE \
    --userId 'I2BrPyhL' \
    --body '{"friendIds": ["5hVys34k", "ZTrS5MMq", "nCjRXFBq"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateConfigV1 \
    --namespace $AB_NAMESPACE \
    --body '{"allowInviteNonConnectedUser": false, "allowJoinPartyDuringMatchmaking": true, "autoKickOnDisconnect": false, "autoKickOnDisconnectDelay": 34, "cancelTicketOnDisconnect": false, "chatRateLimitBurst": 14, "chatRateLimitDuration": 22, "concurrentUsersLimit": 32, "disableInvitationOnJoinParty": false, "enableChat": true, "entitlementCheck": false, "entitlementItemID": "apURRKFj", "generalRateLimitBurst": 10, "generalRateLimitDuration": 37, "keepPresenceActivityOnDisconnect": false, "maxDSWaitTime": 66, "maxPartyMember": 39, "profanityFilter": true, "readyConsentTimeout": 100}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "cqDXLiBg", "topicName": "ViuCqLV5", "userIds": ["y4azNwbN", "7F01D0pX", "wMoRC9tA"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "CLUTEvv3", "topicName": "zBqyEvRD"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'qRC4AeZa' \
    --body '{"message": "1afgDFYF", "topicName": "KLKsYzu4"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'VUroS4Rg' \
    --body '{"templateContext": {"pIr9FoZF": "T0KZKW0I", "0pa8EvJg": "FPDCGEU5", "n0jHX47b": "Zpvt0ies"}, "templateLanguage": "ynZeINXn", "templateSlug": "f3QkVfHD", "topicName": "aujl7A2b"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTemplateV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "CghlbStL", "templateLanguage": "XAsk7CXP", "templateSlug": "TXNEY49C"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"qmR36r0o": "CZX8foDh", "DSScXYiF": "zdRGJusC", "uDwWjR8Q": "xLHYlrfv"}, "templateLanguage": "uSfUPG9N", "templateSlug": "pIALYDKx", "topicName": "bNSmraJk"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getSingleTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'wLs3ZTui' \
    --templateSlug 'dzUsUMN5' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '3q8PMIGg' \
    --templateSlug '2gSNgcd5' \
    --body '{"templateContent": "xq3LzSDZ"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'NWBDQltN' \
    --templateSlug 'zwHzzThN' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'ZqTN7FRw' \
    --templateSlug 'tPEkKkJo' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTopicV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"description": "TN2KfHxP", "topicName": "loQqxf2y"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'MDjKd01y' \
    --body '{"message": "0GDnUb0y", "topicName": "cZoFzSn7"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'd9je5w5Q' \
    --body '{"templateContext": {"FFG5UKMN": "uKdFHlU9", "ZDqkZ3Yw": "FawgKhl9", "7G8zL2rh": "jaavCQiZ"}, "templateLanguage": "fOxOHite", "templateSlug": "SEt53vjz", "topicName": "DhYtx7mj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId '0wpitp0q' \
    --body '{"custom_attribute": {"eOnNlXKS": {}, "cwZbY5EV": {}, "FUK6hoSR": {}}, "updatedAt": 14}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminSetPlayerSessionAttribute \
    --namespace $AB_NAMESPACE \
    --userId 'eU9rwKz0' \
    --body '{"attributes": {"wHXdpjnc": "JqfJweEQ", "rCKluTU2": "vvjfEJvt", "W8wP2nNO": "CZwkrgig"}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkBlockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'JSDTMsSF' \
    --body '{"listBlockedUserId": ["BBrdfVCF", "hV9wnAIP", "mKHKsN9J"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilterIntoList \
    --list 'EYJTzZvY' \
    --namespace $AB_NAMESPACE \
    --body '{"filter": "hAeqZycG", "note": "TGSyCPNw"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilters \
    --list 'ZSt42EYa' \
    --namespace $AB_NAMESPACE \
    --body '{"filters": [{"filter": "z2UmGBn3", "note": "v8P5fkm8"}, {"filter": "gdeIDkjo", "note": "1RWnSptI"}, {"filter": "GGBIrsu1", "note": "LCuLdDEt"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminCreateProfanityList \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": true, "name": "wY1WoYb9"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateProfanityList \
    --list '56jAQlIT' \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": true, "isMandatory": false, "newName": "cUerYYgM"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminVerifyMessageProfanityResponse \
    --namespace $AB_NAMESPACE \
    --body '{"message": "K07TsrWj", "profanityLevel": "xKmDeKvD"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publicUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'Xnbod4zA' \
    --body '{"custom_attribute": {"ASipNB7w": {}, "JvyOu0iI": {}, "9dz53W0Y": {}}, "updatedAt": 70}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotification \
    --namespace $AB_NAMESPACE \
    --body '{"message": "XbOoxRFH", "topic": "kyw8dDOT"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"cv0lm16H": "G8nt8t4I", "qWAZRM2A": "hp9OoeIt", "R9xi0Aea": "VQjkoUnl"}, "templateLanguage": "3avBu02n", "templateSlug": "ZBF3JVVr", "topic": "Y7ZRuDIA"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "m5yVhmFO", "templateLanguage": "VgVH949Z", "templateSlug": "fJHTHOlu"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'm5bzIzuJ' \
    --templateSlug 'X23BDOta' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage '3LLF0ZWp' \
    --templateSlug 'MykzVocj' \
    --body '{"templateContent": "wVyNLcvB"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalization \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'LhqaX04V' \
    --templateSlug 'uXW597wP' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'TrMlwRQh' \
    --templateSlug '3BPJ8hqA' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTopic \
    --namespace $AB_NAMESPACE \
    --body '{"description": "tm9wNkcY", "topic": "1JtG7zdn"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotificationByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'URV1oAQu' \
    --body '{"message": "9dys5FDH", "topic": "NbeDPU1k"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplateByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'JIokFdO6' \
    --body '{"templateContext": {"jjm55mxo": "eFygrEs0", "wGM5wXUa": "CUpwzouB", "EfAEofzS": "B9dPEyzb"}, "templateLanguage": "GUOpqpDe", "templateSlug": "qN25DUkx", "topic": "Scqj9viF"}' \
    > test.out 2>&1
