...
func (o *GetUserOrderGrantOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/grant][%d] getUserOrderGrantOK  %+v", 200, o.ToString())
}

func (o *GetUserOrderGrantOK) ToString() string {
