...
func (o *PublicQueryUserEntitlementsByAppTypeOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/byAppType][%d] publicQueryUserEntitlementsByAppTypeOK  %+v", 200, o.ToString())
}

func (o *PublicQueryUserEntitlementsByAppTypeOK) ToString() string {
