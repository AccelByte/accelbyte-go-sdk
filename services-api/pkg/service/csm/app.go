...
func (aaa *AppService) GetAppListV1(input *app.GetAppListV1Params) (*csmclientmodels.GeneratedGetAppListV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.GetAppListV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *AppService) GetAppV1(input *app.GetAppV1Params) (*csmclientmodels.GeneratedGetAppV1Response, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.GetAppV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *AppService) CreateAppV1(input *app.CreateAppV1Params) (*csmclientmodels.GeneratedCreateAppV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, conflict, internalServerError, err := aaa.Client.App.CreateAppV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AppService) DeleteAppV1(input *app.DeleteAppV1Params) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.DeleteAppV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *AppService) UpdateAppV1(input *app.UpdateAppV1Params) (*csmclientmodels.GeneratedUpdateAppV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.UpdateAppV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AppService) GetAppReleaseV1(input *app.GetAppReleaseV1Params) (*csmclientmodels.GeneratedGetAppReleaseV1Response, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.GetAppReleaseV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *AppService) StartAppV1(input *app.StartAppV1Params) (*csmclientmodels.GeneratedStartAppV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.StartAppV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AppService) StopAppV1(input *app.StopAppV1Params) (*csmclientmodels.GeneratedStopAppV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.App.StopAppV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
