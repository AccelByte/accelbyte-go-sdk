...
func (o *GetPaymentCustomizationOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/payment/customization][%d] getPaymentCustomizationOK  %+v", 200, o.ToString())
}

func (o *GetPaymentCustomizationOK) ToString() string {
