...
func (o *UpdateXblBPCertFileOK) Error() string {
	return fmt.Sprintf("[PUT /platform/admin/namespaces/{namespace}/iap/config/xbl/cert][%d] updateXblBPCertFileOK  %+v", 200, o.ToString())
}

func (o *UpdateXblBPCertFileOK) ToString() string {
