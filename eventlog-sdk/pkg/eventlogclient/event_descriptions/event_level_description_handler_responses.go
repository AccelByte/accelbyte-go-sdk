...
func (o *EventLevelDescriptionHandlerOK) Error() string {
	return fmt.Sprintf("[GET /event/descriptions/eventLevel][%d] eventLevelDescriptionHandlerOK  %+v", 200, o.ToString())
}

func (o *EventLevelDescriptionHandlerOK) ToString() string {
