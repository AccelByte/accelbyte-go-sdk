...
func (o *GetUserEntitlementOwnershipByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemId][%d] getUserEntitlementOwnershipByItemIdOK  %+v", 200, o.ToString())
}

func (o *GetUserEntitlementOwnershipByItemIDOK) ToString() string {
