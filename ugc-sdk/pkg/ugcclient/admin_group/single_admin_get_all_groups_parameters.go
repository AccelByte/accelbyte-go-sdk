...
func (o *SingleAdminGetAllGroupsParams) WithLimit(limit *string) *SingleAdminGetAllGroupsParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the single admin get all groups params
func (o *SingleAdminGetAllGroupsParams) SetLimit(limit *string) {
	o.Limit = limit
}
...
func (o *SingleAdminGetAllGroupsParams) WithOffset(offset *string) *SingleAdminGetAllGroupsParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the single admin get all groups params
func (o *SingleAdminGetAllGroupsParams) SetOffset(offset *string) {
	o.Offset = offset
}
