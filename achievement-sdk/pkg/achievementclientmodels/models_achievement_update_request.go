...
func (m *ModelsAchievementUpdateRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *ModelsAchievementUpdateRequest) validateName(formats strfmt.Registry) error {
