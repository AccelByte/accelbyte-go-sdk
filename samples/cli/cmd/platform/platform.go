...
func init() {
	...
	PlatformCmd.AddCommand(entitlement.QueryEntitlementsByItemIdsCmd)
	...
	PlatformCmd.AddCommand(clawback.MockXblClawbackEventCmd)
	...
	PlatformCmd.AddCommand(iapSubscription.ListOculusSubscriptionGroupsCmd)
	PlatformCmd.AddCommand(iapSubscription.CreateOculusSubscriptionGroupCmd)
	PlatformCmd.AddCommand(iapSubscription.DeleteOculusSubscriptionGroupCmd)
	PlatformCmd.AddCommand(iapSubscription.ListOculusSubscriptionGroupTierCmd)
	PlatformCmd.AddCommand(iapSubscription.AddTierIntoMetaQuestSubscriptionGroupCmd)
	PlatformCmd.AddCommand(iapSubscription.DeleteOculusSubscriptionTierCmd)
	...
	PlatformCmd.AddCommand(iap.QueryAbnormalTransactionsCmd)
	PlatformCmd.AddCommand(iap.AdminGetSteamJobInfoCmd)
	PlatformCmd.AddCommand(iap.AdminResetSteamJobTimeCmd)
	PlatformCmd.AddCommand(iap.AdminRefundIAPOrderCmd)
	PlatformCmd.AddCommand(iap.QuerySteamReportHistoriesCmd)
	PlatformCmd.AddCommand(iapSubscription.QueryThirdPartySubscriptionCmd)
	PlatformCmd.AddCommand(iap.GetIAPOrderConsumeDetailsCmd)
	...
	PlatformCmd.AddCommand(item.QueryItemReferencesCmd)
	...
	PlatformCmd.AddCommand(servicePluginConfig.GetRevocationPluginConfigCmd)
	PlatformCmd.AddCommand(servicePluginConfig.UpdateRevocationPluginConfigCmd)
	PlatformCmd.AddCommand(servicePluginConfig.DeleteRevocationPluginConfigCmd)
	PlatformCmd.AddCommand(servicePluginConfig.UploadRevocationPluginConfigCertV2Cmd)
	...
	PlatformCmd.AddCommand(store.GetCatalogDefinitionCmd)
	PlatformCmd.AddCommand(store.DownloadCSVTemplatesCmd)
	PlatformCmd.AddCommand(store.ExportStoreByCSVCmd)
	...
	PlatformCmd.AddCommand(catalogChanges.SelectAllRecordsByCriteriaCmd)
	...
	PlatformCmd.AddCommand(store.QueryImportHistoryCmd)
	PlatformCmd.AddCommand(store.ImportStoreByCSVCmd)
	...
	PlatformCmd.AddCommand(entitlement.GetUserEntitlementsByIdsCmd)
	...
	PlatformCmd.AddCommand(entitlement.RevokeUserEntitlementByUseCountCmd)
	PlatformCmd.AddCommand(entitlement.PreCheckRevokeUserEntitlementByUseCountCmd)
	...
	PlatformCmd.AddCommand(fulfillment.PreCheckFulfillItemCmd)
	...
	PlatformCmd.AddCommand(iap.AdminSyncOculusSubscriptionsCmd)
	PlatformCmd.AddCommand(iap.AdminGetIAPOrderLineItemsCmd)
	PlatformCmd.AddCommand(iap.AdminSyncSteamAbnormalTransactionCmd)
	PlatformCmd.AddCommand(iap.AdminSyncSteamIAPByTransactionCmd)
	...
	PlatformCmd.AddCommand(wallet.CheckBalanceCmd)
	...
	PlatformCmd.AddCommand(item.PublicGetEstimatedPriceCmd)
	...
	PlatformCmd.AddCommand(entitlement.PublicSplitUserEntitlementCmd)
	PlatformCmd.AddCommand(entitlement.PublicTransferUserEntitlementCmd)
	...
	PlatformCmd.AddCommand(iap.SyncOculusSubscriptionsCmd)
	...
	PlatformCmd.AddCommand(iap.SyncSteamAbnormalTransactionCmd)
	PlatformCmd.AddCommand(iap.SyncSteamIAPByTransactionCmd)
	...
	PlatformCmd.AddCommand(order.PublicPreviewOrderPriceCmd)
	...
	PlatformCmd.AddCommand(fulfillment.BulkFulfillItemsV3Cmd)
