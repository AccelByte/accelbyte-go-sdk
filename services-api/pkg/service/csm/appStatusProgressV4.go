...
// Deprecated: 2022-01-10 - please use GetAppStatusProgressV4Short instead.
func (aaa *AppStatusProgressV4Service) GetAppStatusProgressV4(input *app_status_progress_v4.GetAppStatusProgressV4Params) (*csmclientmodels.ApimodelGetAppStatusProgressResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AppStatusProgressV4.GetAppStatusProgressV4(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
...
func (aaa *AppStatusProgressV4Service) GetAppStatusProgressV4Short(input *app_status_progress_v4.GetAppStatusProgressV4Params) (*csmclientmodels.ApimodelGetAppStatusProgressResponse, error) {
