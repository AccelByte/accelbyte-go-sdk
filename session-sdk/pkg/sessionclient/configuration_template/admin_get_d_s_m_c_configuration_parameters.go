...
for the admin get d s m c configuration operation typically these are written to a http.Request
*/
...
// WithNamespace adds the namespace to the admin get d s m c configuration params
func (o *AdminGetDSMCConfigurationParams) WithNamespace(namespace string) *AdminGetDSMCConfigurationParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the admin get d s m c configuration params
