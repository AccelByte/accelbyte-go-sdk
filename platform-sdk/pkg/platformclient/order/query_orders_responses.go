...
func (o *QueryOrdersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/orders returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *QueryOrdersOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/orders][%d] queryOrdersOK  %+v", 200, o.Payload)
}
...
func (o *QueryOrdersUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/orders][%d] queryOrdersUnprocessableEntity  %+v", 422, o.Payload)
}
