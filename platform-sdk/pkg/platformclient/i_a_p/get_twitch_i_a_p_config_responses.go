...
func (o *GetTwitchIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/twitch][%d] getTwitchIAPConfigOK  %+v", 200, o.ToString())
}

func (o *GetTwitchIAPConfigOK) ToString() string {
