...
func init() {
	...
	IamCmd.AddCommand(oAuth.NamespaceScopedPlatformTokenGrantCmd)
	...
	IamCmd.AddCommand(users.PublicWebReauthPlatformCmd)
	IamCmd.AddCommand(users.PublicWebReauthPlatformEstablishCmd)
	IamCmd.AddCommand(users.PublicWebReauthPlatformProcessCmd)
