...
func (o *ResetPlatformWalletConfigOK) Error() string {
	return fmt.Sprintf("[PUT /platform/admin/namespaces/{namespace}/platforms/{platform}/wallet/config/reset][%d] resetPlatformWalletConfigOK  %+v", 200, o.ToString())
}

func (o *ResetPlatformWalletConfigOK) ToString() string {
