...
func (aaa *DeploymentService) CreateDeploymentV1(input *deployment.CreateDeploymentV1Params) (*csmclientmodels.GeneratedCreateDeploymentV1Response, error) {
	...
	created, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Deployment.CreateDeploymentV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *DeploymentService) GetListOfDeploymentV1(input *deployment.GetListOfDeploymentV1Params) (*csmclientmodels.GeneratedGetDeploymentListV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Deployment.GetListOfDeploymentV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *DeploymentService) GetDeploymentV1(input *deployment.GetDeploymentV1Params) (*csmclientmodels.GeneratedGetDeploymentV1Response, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Deployment.GetDeploymentV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *DeploymentService) DeleteDeploymentV1(input *deployment.DeleteDeploymentV1Params) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Deployment.DeleteDeploymentV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
