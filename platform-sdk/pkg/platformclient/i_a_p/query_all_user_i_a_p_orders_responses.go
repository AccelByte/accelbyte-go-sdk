...
func (o *QueryAllUserIAPOrdersOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/iap/all][%d] queryAllUserIAPOrdersOK  %+v", 200, o.ToString())
}

func (o *QueryAllUserIAPOrdersOK) ToString() string {
