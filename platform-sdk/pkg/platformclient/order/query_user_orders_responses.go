...
func (o *QueryUserOrdersOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/orders][%d] queryUserOrdersOK  %+v", 200, o.ToString())
}

func (o *QueryUserOrdersOK) ToString() string {
