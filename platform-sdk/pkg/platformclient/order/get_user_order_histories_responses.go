...
func (o *GetUserOrderHistoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetUserOrderHistoriesOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history][%d] getUserOrderHistoriesOK  %+v", 200, o.Payload)
}
