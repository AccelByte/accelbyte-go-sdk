...
func (o *BulkIncUserStatItemReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested PUT /v1/admin/namespaces/{namespace}/statitems/value/bulk returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *BulkIncUserStatItemOK) Error() string {
	return fmt.Sprintf("[PUT /v1/admin/namespaces/{namespace}/statitems/value/bulk][%d] bulkIncUserStatItemOK  %+v", 200, o.Payload)
}
...
func (o *BulkIncUserStatItemUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PUT /v1/admin/namespaces/{namespace}/statitems/value/bulk][%d] bulkIncUserStatItemUnprocessableEntity  %+v", 422, o.Payload)
}
