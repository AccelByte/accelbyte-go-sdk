...
func (o *PublicExistsAnyUserActiveEntitlementReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /public/namespaces/{namespace}/users/{userId}/entitlements/ownership/any returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *PublicExistsAnyUserActiveEntitlementOK) Error() string {
	return fmt.Sprintf("[GET /public/namespaces/{namespace}/users/{userId}/entitlements/ownership/any][%d] publicExistsAnyUserActiveEntitlementOK  %+v", 200, o.Payload)
}
