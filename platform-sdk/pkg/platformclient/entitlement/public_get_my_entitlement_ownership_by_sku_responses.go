...
func (o *PublicGetMyEntitlementOwnershipBySkuOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/me/entitlements/ownership/bySku][%d] publicGetMyEntitlementOwnershipBySkuOK  %+v", 200, o.Payload)
}
