...
func (aaa *ConfigService) AdminGetLogConfig(input *config.AdminGetLogConfigParams) (*lobbyclientmodels.LogconfigConfiguration, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
...
func (aaa *ConfigService) AdminPatchUpdateLogConfig(input *config.AdminPatchUpdateLogConfigParams) (*lobbyclientmodels.LogconfigConfiguration, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
