...
func (o *GetAppleIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/apple][%d] getAppleIAPConfigOK  %+v", 200, o.ToString())
}

func (o *GetAppleIAPConfigOK) ToString() string {
