...
func (m *ModelsUpdateMemberRoleResponseV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsUpdateMemberRoleResponseV1) validateMemberRoleID(formats strfmt.Registry) error {
...
func (m *ModelsUpdateMemberRoleResponseV1) validateMemberRoleName(formats strfmt.Registry) error {
...
func (m *ModelsUpdateMemberRoleResponseV1) validateMemberRolePermissions(formats strfmt.Registry) error {
...
func (m *ModelsUpdateMemberRoleResponseV1) UnmarshalBinary(b []byte) error {
	var res ModelsUpdateMemberRoleResponseV1
