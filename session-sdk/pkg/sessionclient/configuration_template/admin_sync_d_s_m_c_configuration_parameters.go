...
for the admin sync d s m c configuration operation typically these are written to a http.Request
*/
...
// WithNamespace adds the namespace to the admin sync d s m c configuration params
func (o *AdminSyncDSMCConfigurationParams) WithNamespace(namespace string) *AdminSyncDSMCConfigurationParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the admin sync d s m c configuration params
