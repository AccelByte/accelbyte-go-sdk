...
func (o *AdminUpdateRoleV3OK) Error() string {
	return fmt.Sprintf("[PATCH /iam/v3/admin/roles/{roleId}][%d] adminUpdateRoleV3OK  %+v", 200, o.Payload)
}
...
func (o *AdminUpdateRoleV3BadRequest) Error() string {
	return fmt.Sprintf("[PATCH /iam/v3/admin/roles/{roleId}][%d] adminUpdateRoleV3BadRequest  %+v", 400, o.Payload)
}
...
func (o *AdminUpdateRoleV3Unauthorized) Error() string {
	return fmt.Sprintf("[PATCH /iam/v3/admin/roles/{roleId}][%d] adminUpdateRoleV3Unauthorized  %+v", 401, o.Payload)
}
...
func (o *AdminUpdateRoleV3Forbidden) Error() string {
	return fmt.Sprintf("[PATCH /iam/v3/admin/roles/{roleId}][%d] adminUpdateRoleV3Forbidden  %+v", 403, o.Payload)
}
...
func (o *AdminUpdateRoleV3NotFound) Error() string {
	return fmt.Sprintf("[PATCH /iam/v3/admin/roles/{roleId}][%d] adminUpdateRoleV3NotFound  %+v", 404, o.Payload)
}
