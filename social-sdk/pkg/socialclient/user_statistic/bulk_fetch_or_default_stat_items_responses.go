...
func (o *BulkFetchOrDefaultStatItemsOK) Error() string {
	return fmt.Sprintf("[GET /social/v1/admin/namespaces/{namespace}/statitems/value/bulk/getOrDefault][%d] bulkFetchOrDefaultStatItemsOK  %+v", 200, o.Payload)
}
...
func (o *BulkFetchOrDefaultStatItemsNotFound) Error() string {
	return fmt.Sprintf("[GET /social/v1/admin/namespaces/{namespace}/statitems/value/bulk/getOrDefault][%d] bulkFetchOrDefaultStatItemsNotFound  %+v", 404, o.Payload)
}
...
func (o *BulkFetchOrDefaultStatItemsUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /social/v1/admin/namespaces/{namespace}/statitems/value/bulk/getOrDefault][%d] bulkFetchOrDefaultStatItemsUnprocessableEntity  %+v", 422, o.Payload)
}
