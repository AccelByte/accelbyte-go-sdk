...
func (o *QueryUserIAPOrdersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/users/{userId}/iap returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *QueryUserIAPOrdersOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/users/{userId}/iap][%d] queryUserIAPOrdersOK  %+v", 200, o.Payload)
}
