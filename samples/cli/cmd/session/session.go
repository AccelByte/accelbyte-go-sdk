...
func init() {
	...
	SessionCmd.AddCommand(gameSession.PublicGetGameSessionPasswordCmd)
	SessionCmd.AddCommand(gameSession.PublicUpdateGameSessionPasswordCmd)
	...
	SessionCmd.AddCommand(party.PublicGetPartyPasswordCmd)
	SessionCmd.AddCommand(party.PublicUpdatePartyPasswordCmd)
	...
	SessionCmd.AddCommand(sessionStorage.PublicReplaceSessionStorageLeaderV2Cmd)
	SessionCmd.AddCommand(sessionStorage.PublicUpdateInsertSessionStorageLeaderV2Cmd)
	SessionCmd.AddCommand(sessionStorage.PublicReplaceSessionStorageUserV2Cmd)
	SessionCmd.AddCommand(sessionStorage.PublicUpdateInsertSessionStorageUserV2Cmd)
}
