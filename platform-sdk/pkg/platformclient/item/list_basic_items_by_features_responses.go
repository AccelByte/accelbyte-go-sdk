...
func (o *ListBasicItemsByFeaturesOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/items/byFeatures/basic][%d] listBasicItemsByFeaturesOK  %+v", 200, o.ToString())
}

func (o *ListBasicItemsByFeaturesOK) ToString() string {
