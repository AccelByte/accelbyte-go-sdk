...
// Deprecated: 2022-01-10 - please use DeleteAllUserRankingByCycleIDAdminV3Short instead.
func (aaa *LeaderboardDataV3Service) DeleteAllUserRankingByCycleIDAdminV3(input *leaderboard_data_v3.DeleteAllUserRankingByCycleIDAdminV3Params) error {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return err
	}
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.LeaderboardDataV3.DeleteAllUserRankingByCycleIDAdminV3(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
...
// Deprecated: 2022-01-10 - please use DeleteUserRankingByCycleIDAdminV3Short instead.
func (aaa *LeaderboardDataV3Service) DeleteUserRankingByCycleIDAdminV3(input *leaderboard_data_v3.DeleteUserRankingByCycleIDAdminV3Params) error {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return err
	}
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.LeaderboardDataV3.DeleteUserRankingByCycleIDAdminV3(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
