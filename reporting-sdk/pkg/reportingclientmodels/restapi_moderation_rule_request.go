...
func (m *RestapiModerationRuleRequest) validateAction(formats strfmt.Registry) error {
...
func (m *RestapiModerationRuleRequest) validateActions(formats strfmt.Registry) error {
