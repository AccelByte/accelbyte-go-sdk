...
for the public send my m f a email code v4 operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) WithTimeout(timeout time.Duration) *PublicSendMyMFAEmailCodeV4Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) WithContext(ctx context.Context) *PublicSendMyMFAEmailCodeV4Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// SetAuthInfoWriter adds the authInfoWriter to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) SetAuthInfoWriter(authInfoWriter runtime.ClientAuthInfoWriter) {
	o.AuthInfoWriter = authInfoWriter
}

// WithHTTPClient adds the HTTPClient to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) WithHTTPClient(client *http.Client) *PublicSendMyMFAEmailCodeV4Params {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// SetHTTPClient adds the HTTPClient Transport to the public send my m f a email code v4 params
...
// WithNamespace adds the namespace to the public send my m f a email code v4 params
func (o *PublicSendMyMFAEmailCodeV4Params) WithNamespace(namespace string) *PublicSendMyMFAEmailCodeV4Params {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the public send my m f a email code v4 params
