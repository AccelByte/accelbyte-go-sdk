...
func (o *OperationsService) PublicGetMessagesShort(input *operations.PublicGetMessagesParams, authInfo runtime.ClientAuthInfoWriter) ([]*dslogmanagerclientmodels.LogAppMessageDeclaration, error) {
