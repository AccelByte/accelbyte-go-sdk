...
func (o *PublicGetCategoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /public/namespaces/{namespace}/categories/{categoryPath} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *PublicGetCategoryOK) Error() string {
	return fmt.Sprintf("[GET /public/namespaces/{namespace}/categories/{categoryPath}][%d] publicGetCategoryOK  %+v", 200, o.Payload)
}
...
func (o *PublicGetCategoryNotFound) Error() string {
	return fmt.Sprintf("[GET /public/namespaces/{namespace}/categories/{categoryPath}][%d] publicGetCategoryNotFound  %+v", 404, o.Payload)
}
