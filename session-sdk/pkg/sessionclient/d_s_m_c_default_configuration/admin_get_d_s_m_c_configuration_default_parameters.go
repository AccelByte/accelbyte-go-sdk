...
for the admin get d s m c configuration default operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the admin get d s m c configuration default params
...
// SetTimeout adds the timeout to the admin get d s m c configuration default params
func (o *AdminGetDSMCConfigurationDefaultParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the admin get d s m c configuration default params
func (o *AdminGetDSMCConfigurationDefaultParams) WithContext(ctx context.Context) *AdminGetDSMCConfigurationDefaultParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin get d s m c configuration default params
func (o *AdminGetDSMCConfigurationDefaultParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// SetAuthInfoWriter adds the authInfoWriter to the admin get d s m c configuration default params
func (o *AdminGetDSMCConfigurationDefaultParams) SetAuthInfoWriter(authInfoWriter runtime.ClientAuthInfoWriter) {
	o.AuthInfoWriter = authInfoWriter
}

// WithHTTPClient adds the HTTPClient to the admin get d s m c configuration default params
...
// SetHTTPClient adds the HTTPClient to the admin get d s m c configuration default params
func (o *AdminGetDSMCConfigurationDefaultParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// SetHTTPClient adds the HTTPClient Transport to the admin get d s m c configuration default params
