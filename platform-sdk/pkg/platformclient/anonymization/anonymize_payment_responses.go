...
func (o *AnonymizePaymentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested DELETE /admin/namespaces/{namespace}/users/{userId}/anonymization/payment returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AnonymizePaymentNoContent) Error() string {
	return fmt.Sprintf("[DELETE /admin/namespaces/{namespace}/users/{userId}/anonymization/payment][%d] anonymizePaymentNoContent ", 204)
}
