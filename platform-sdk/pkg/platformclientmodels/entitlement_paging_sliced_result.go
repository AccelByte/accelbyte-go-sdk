...
func (m *EntitlementPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *EntitlementPagingSlicedResult) validatePaging(formats strfmt.Registry) error {
