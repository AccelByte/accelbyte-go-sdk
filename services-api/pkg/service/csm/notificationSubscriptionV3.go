...
func (aaa *NotificationSubscriptionV3Service) GetNotificationSubscriberListV3(input *notification_subscription_v3.GetNotificationSubscriberListV3Params) (*csmclientmodels.ApimodelGetNotificationSubscriberListResponseV2, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.NotificationSubscriptionV3.GetNotificationSubscriberListV3(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
...
func (aaa *NotificationSubscriptionV3Service) DeleteSubscriptionAppNotificationV3(input *notification_subscription_v3.DeleteSubscriptionAppNotificationV3Params) error {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return err
	}
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.NotificationSubscriptionV3.DeleteSubscriptionAppNotificationV3(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
...
func (aaa *NotificationSubscriptionV3Service) GetNotificationSubscriberListV3Short(input *notification_subscription_v3.GetNotificationSubscriberListV3Params) (*csmclientmodels.ApimodelGetNotificationSubscriberListResponseV2, error) {
