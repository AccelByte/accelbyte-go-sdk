...
func init() {
	cmd.RootCmd.AddCommand(bulkIncUserStatItemCmd)
	bulkIncUserStatItemCmd.Flags().StringP("body", "b", " ", "Body")
	bulkIncUserStatItemCmd.Flags().StringP("namespace", "n", " ", "Namespace")
