...
func (o *SpecificAgentTypeDescriptionHandlerOK) Error() string {
	return fmt.Sprintf("[GET /event/descriptions/agentType/listByAgentTypes][%d] specificAgentTypeDescriptionHandlerOK  %+v", 200, o.ToString())
}

func (o *SpecificAgentTypeDescriptionHandlerOK) ToString() string {
