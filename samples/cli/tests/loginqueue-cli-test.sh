...
samples/cli/sample-apps Loginqueue adminUpdateConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"enabled": true, "maxConcurrency": 94, "maxLoginRate": 55, "minActivationPeriodInSecond": 23, "playerPollingTimeInSecond": 80, "playerReconnectGracePeriodInSecond": 60, "queueReconnectGracePeriodInSecond": 24, "safetyMarginPercentage": 77}' \
    > test.out 2>&1
