...
func (o *PublicGetMyBackupCodesV4OK) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4OK  %+v", 200, o.Payload)
}
...
func (o *PublicGetMyBackupCodesV4BadRequest) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4BadRequest  %+v", 400, o.Payload)
}
...
func (o *PublicGetMyBackupCodesV4Unauthorized) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4Unauthorized  %+v", 401, o.Payload)
}
...
func (o *PublicGetMyBackupCodesV4Forbidden) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4Forbidden  %+v", 403, o.Payload)
}
...
func (o *PublicGetMyBackupCodesV4NotFound) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4NotFound  %+v", 404, o.Payload)
}
...
func (o *PublicGetMyBackupCodesV4InternalServerError) Error() string {
	return fmt.Sprintf("[GET /iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode][%d] publicGetMyBackupCodesV4InternalServerError  %+v", 500, o.Payload)
}
