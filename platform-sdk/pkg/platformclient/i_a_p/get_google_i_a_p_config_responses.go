...
func (o *GetGoogleIAPConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/iap/config/google returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetGoogleIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/iap/config/google][%d] getGoogleIAPConfigOK  %+v", 200, o.Payload)
}
