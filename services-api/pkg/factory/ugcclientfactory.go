...
func newCustomUgcHttpClientWithConfig(formats strfmt.Registry, cfg *ugcclient.TransportConfig, userAgent, xAmazonTraceId string) *ugcclient.JusticeUgcService {
	if cfg == nil {
		cfg = ugcclient.DefaultTransportConfig()
	}
...
func newCustomUgcHttpClient(formats strfmt.Registry) *ugcclient.JusticeUgcService {
	return newCustomUgcHttpClientWithConfig(formats, nil, "", "")
}
