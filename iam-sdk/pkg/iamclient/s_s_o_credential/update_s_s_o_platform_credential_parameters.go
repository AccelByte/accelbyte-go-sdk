...
for the update s s o platform credential operation typically these are written to a http.Request
*/
...
// SetHTTPClient adds the HTTPClient Transport to the update s s o platform credential params
