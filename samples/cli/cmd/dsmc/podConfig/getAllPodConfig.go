...
func init() {
	...
	getAllPodConfigCmd.Flags().StringP("namespace", "n", " ", "Namespace")
	_ = getAllPodConfigCmd.MarkFlagRequired("namespace")
	getAllPodConfigCmd.Flags().Int64P("count", "c", 1, "Count")
	getAllPodConfigCmd.Flags().Int64P("offset", "o", 0, "Offset")
}
