...
func (aaa *ImageV2Service) GetAppImageListV2(input *image_v2.GetAppImageListV2Params) (*csmclientmodels.ApimodelGetAppImageListV2Response, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.ImageV2.GetAppImageListV2(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
...
func (aaa *ImageV2Service) DeleteAppImagesV2(input *image_v2.DeleteAppImagesV2Params) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.ImageV2.DeleteAppImagesV2(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
