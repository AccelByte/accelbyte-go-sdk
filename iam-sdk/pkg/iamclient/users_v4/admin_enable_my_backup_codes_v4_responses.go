...
func (o *AdminEnableMyBackupCodesV4OK) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4OK  %+v", 200, o.Payload)
}
...
/*AdminEnableMyBackupCodesV4BadRequest handles this case with default header values.
  ...
  <table><tr><td>errorCode</td><td>errorMessage</td></tr><tr><td>10191</td><td>email address not verified</td></tr><tr><td>10194</td><td>factor already enabled</td></tr></table>
*/
...
func (o *AdminEnableMyBackupCodesV4BadRequest) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4BadRequest  %+v", 400, o.Payload)
}
...
func (o *AdminEnableMyBackupCodesV4Unauthorized) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4Unauthorized  %+v", 401, o.Payload)
}
...
func (o *AdminEnableMyBackupCodesV4Forbidden) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4Forbidden  %+v", 403, o.Payload)
}
...
func (o *AdminEnableMyBackupCodesV4NotFound) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4NotFound  %+v", 404, o.Payload)
}
...
func (o *AdminEnableMyBackupCodesV4Conflict) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4Conflict  %+v", 409, o.Payload)
}
...
func (o *AdminEnableMyBackupCodesV4InternalServerError) Error() string {
	return fmt.Sprintf("[POST /iam/v4/admin/users/me/mfa/backupCode/enable][%d] adminEnableMyBackupCodesV4InternalServerError  %+v", 500, o.Payload)
}
