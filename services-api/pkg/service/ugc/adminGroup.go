...
// [{'HasPermission': ['ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENTGROUP [READ]'], 'authorization': []}]
...
// [{'HasPermission': ['ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENTGROUP [CREATE]'], 'authorization': []}]
...
// [{'HasPermission': ['ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENTGROUP [UPDATE]'], 'authorization': []}]
