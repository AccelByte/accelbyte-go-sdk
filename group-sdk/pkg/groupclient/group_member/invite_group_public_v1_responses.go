...
func (o *InviteGroupPublicV1OK) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1OK  %+v", 200, o.Payload)
}
...
func (o *InviteGroupPublicV1BadRequest) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *InviteGroupPublicV1Unauthorized) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1Unauthorized  %+v", 401, o.Payload)
}
...
func (o *InviteGroupPublicV1Forbidden) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *InviteGroupPublicV1NotFound) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1NotFound  %+v", 404, o.Payload)
}
...
func (o *InviteGroupPublicV1Conflict) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1Conflict  %+v", 409, o.Payload)
}
...
func (o *InviteGroupPublicV1InternalServerError) Error() string {
	return fmt.Sprintf("[POST /group/v1/public/namespaces/{namespace}/users/{userId}/invite][%d] inviteGroupPublicV1InternalServerError  %+v", 500, o.Payload)
}
