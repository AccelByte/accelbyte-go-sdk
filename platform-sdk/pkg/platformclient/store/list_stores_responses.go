...
func (o *ListStoresReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/stores returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ListStoresOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/stores][%d] listStoresOK  %+v", 200, o.Payload)
}
