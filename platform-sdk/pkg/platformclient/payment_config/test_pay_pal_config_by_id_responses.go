...
func (o *TestPayPalConfigByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/payment/config/merchant/{id}/paypalconfig/test returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *TestPayPalConfigByIDOK) Error() string {
	return fmt.Sprintf("[GET /admin/payment/config/merchant/{id}/paypalconfig/test][%d] testPayPalConfigByIdOK  %+v", 200, o.Payload)
}
...
func (o *TestPayPalConfigByIDNotFound) Error() string {
	return fmt.Sprintf("[GET /admin/payment/config/merchant/{id}/paypalconfig/test][%d] testPayPalConfigByIdNotFound  %+v", 404, o.Payload)
}
