...
func (o *GetRootCategoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/categories returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetRootCategoriesOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/categories][%d] getRootCategoriesOK  %+v", 200, o.Payload)
}
