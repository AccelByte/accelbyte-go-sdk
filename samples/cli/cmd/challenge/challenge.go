...
func init() {
	...
	ChallengeCmd.AddCommand(goalConfiguration.AdminMoveGoalToSlotCmd)
	...
	ChallengeCmd.AddCommand(goalConfiguration.AdminGetChallengeSlotsCmd)
	...
	ChallengeCmd.AddCommand(challengeList.PublicGetChallengesCmd)
	...
	ChallengeCmd.AddCommand(challengeProgression.PublicEvaluateMyProgressCmd)
