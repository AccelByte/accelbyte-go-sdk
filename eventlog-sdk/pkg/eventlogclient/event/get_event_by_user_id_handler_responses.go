...
func (o *GetEventByUserIDHandlerOK) Error() string {
	return fmt.Sprintf("[GET /event/namespaces/{namespace}/users/{userId}][%d] getEventByUserIdHandlerOK  %+v", 200, o.ToString())
}

func (o *GetEventByUserIDHandlerOK) ToString() string {
