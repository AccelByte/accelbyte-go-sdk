...
func (o *GetEventByEventTypeHandlerParams) WithOffset(offset *float64) *GetEventByEventTypeHandlerParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get event by event type handler params
func (o *GetEventByEventTypeHandlerParams) SetOffset(offset *float64) {
	o.Offset = offset
}

// WithPageSize adds the pageSize to the get event by event type handler params
func (o *GetEventByEventTypeHandlerParams) WithPageSize(pageSize float64) *GetEventByEventTypeHandlerParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the get event by event type handler params
func (o *GetEventByEventTypeHandlerParams) SetPageSize(pageSize float64) {
	o.PageSize = pageSize
}
