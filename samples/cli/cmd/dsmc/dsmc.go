...
func init() {
	...
	DsmcCmd.AddCommand(admin.GetWorkerConfigCmd)
	DsmcCmd.AddCommand(admin.UpdateWorkerConfigCmd)
	DsmcCmd.AddCommand(admin.CreateWorkerConfigCmd)
	...
	DsmcCmd.AddCommand(deploymentConfig.DeleteCreatingServerCountQueueCmd)
	...
	DsmcCmd.AddCommand(admin.AddBufferCmd)
	DsmcCmd.AddCommand(imageConfig.GetRepositoryCmd)
	...
	DsmcCmd.AddCommand(admin.RunGhostCleanerRequestHandlerCmd)
	DsmcCmd.AddCommand(admin.RunZombieCleanerRequestHandlerCmd)
	DsmcCmd.AddCommand(imageConfig.CreateRepositoryCmd)
	DsmcCmd.AddCommand(config.ExportConfigV1Cmd)
	DsmcCmd.AddCommand(config.ImportConfigV1Cmd)
	DsmcCmd.AddCommand(deploymentConfig.GetAllDeploymentClientCmd)
	DsmcCmd.AddCommand(deploymentConfig.GetDeploymentClientCmd)
	DsmcCmd.AddCommand(deploymentConfig.CreateDeploymentClientCmd)
	DsmcCmd.AddCommand(deploymentConfig.DeleteDeploymentClientCmd)
	...
	DsmcCmd.AddCommand(server.CountServerDetailedClientCmd)
	DsmcCmd.AddCommand(server.ServerHeartbeatCmd)
	...
	DsmcCmd.AddCommand(server.GetServerSessionTimeoutCmd)
	...
	DsmcCmd.AddCommand(session.CancelSessionCmd)
