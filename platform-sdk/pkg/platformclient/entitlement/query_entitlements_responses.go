...
func (o *QueryEntitlementsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /admin/namespaces/{namespace}/entitlements returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *QueryEntitlementsOK) Error() string {
	return fmt.Sprintf("[GET /admin/namespaces/{namespace}/entitlements][%d] queryEntitlementsOK  %+v", 200, o.Payload)
}
