...
func (o *GetUserEntitlementByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemId][%d] getUserEntitlementByItemIdOK  %+v", 200, o.ToString())
}

func (o *GetUserEntitlementByItemIDOK) ToString() string {
...
func (o *GetUserEntitlementByItemIDNotFound) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemId][%d] getUserEntitlementByItemIdNotFound  %+v", 404, o.ToString())
}

func (o *GetUserEntitlementByItemIDNotFound) ToString() string {
	b, err := json.Marshal(o.Payload)
	if err != nil {
		fmt.Println(err)
	}
