...
for the get user d l c operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the get user d l c params
func (o *GetUserDLCParams) WithTimeout(timeout time.Duration) *GetUserDLCParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get user d l c params
func (o *GetUserDLCParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get user d l c params
func (o *GetUserDLCParams) WithContext(ctx context.Context) *GetUserDLCParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get user d l c params
func (o *GetUserDLCParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// SetAuthInfoWriter adds the authInfoWriter to the get user d l c params
func (o *GetUserDLCParams) SetAuthInfoWriter(authInfoWriter runtime.ClientAuthInfoWriter) {
	o.AuthInfoWriter = authInfoWriter
}

// WithHTTPClient adds the HTTPClient to the get user d l c params
func (o *GetUserDLCParams) WithHTTPClient(client *http.Client) *GetUserDLCParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get user d l c params
func (o *GetUserDLCParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// SetHTTPClient adds the HTTPClient Transport to the get user d l c params
...
// WithNamespace adds the namespace to the get user d l c params
func (o *GetUserDLCParams) WithNamespace(namespace string) *GetUserDLCParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the get user d l c params
func (o *GetUserDLCParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithType adds the typeVar to the get user d l c params
func (o *GetUserDLCParams) WithType(typeVar string) *GetUserDLCParams {
	o.SetType(typeVar)
	return o
}

// SetType adds the type to the get user d l c params
func (o *GetUserDLCParams) SetType(typeVar string) {
	o.Type = typeVar
}

// WithUserID adds the userID to the get user d l c params
func (o *GetUserDLCParams) WithUserID(userID string) *GetUserDLCParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get user d l c params
