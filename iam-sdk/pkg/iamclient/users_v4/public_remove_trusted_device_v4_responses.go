...
func (o *PublicRemoveTrustedDeviceV4BadRequest) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/device][%d] publicRemoveTrustedDeviceV4BadRequest  %+v", 400, o.Payload)
}
...
func (o *PublicRemoveTrustedDeviceV4Unauthorized) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/device][%d] publicRemoveTrustedDeviceV4Unauthorized  %+v", 401, o.Payload)
}
...
func (o *PublicRemoveTrustedDeviceV4Forbidden) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/device][%d] publicRemoveTrustedDeviceV4Forbidden  %+v", 403, o.Payload)
}
...
func (o *PublicRemoveTrustedDeviceV4NotFound) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/device][%d] publicRemoveTrustedDeviceV4NotFound  %+v", 404, o.Payload)
}
...
func (o *PublicRemoveTrustedDeviceV4InternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /iam/v4/public/namespaces/{namespace}/users/me/mfa/device][%d] publicRemoveTrustedDeviceV4InternalServerError  %+v", 500, o.Payload)
}
