...
func (o *SpecificEventLevelDescriptionHandlerOK) Error() string {
	return fmt.Sprintf("[GET /event/descriptions/eventLevel/listByEventLevels][%d] specificEventLevelDescriptionHandlerOK  %+v", 200, o.ToString())
}

func (o *SpecificEventLevelDescriptionHandlerOK) ToString() string {
