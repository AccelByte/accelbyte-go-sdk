...
type ClientService interface {
	...
	MockPlayStationStreamEvent(params *MockPlayStationStreamEventParams, authInfo runtime.ClientAuthInfoWriter) (*MockPlayStationStreamEventNoContent, error)
	MockPlayStationStreamEventShort(params *MockPlayStationStreamEventParams, authInfo runtime.ClientAuthInfoWriter) (*MockPlayStationStreamEventNoContent, error)
...
*/
func (a *Client) MockPlayStationStreamEvent(params *MockPlayStationStreamEventParams, authInfo runtime.ClientAuthInfoWriter) (*MockPlayStationStreamEventNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	case *MockPlayStationStreamEventNoContent:
		return v, nil
...
Other detail info:
  ...
  * Required permission : resource=ADMIN:NAMESPACE:{namespace}:IAP:CLAWBACK, action=1(CREATE)
*/
func (a *Client) MockPlayStationStreamEventShort(params *MockPlayStationStreamEventParams, authInfo runtime.ClientAuthInfoWriter) (*MockPlayStationStreamEventNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewMockPlayStationStreamEventParams()
	}
