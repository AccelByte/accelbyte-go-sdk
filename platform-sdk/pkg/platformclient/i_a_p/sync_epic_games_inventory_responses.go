...
func (o *SyncEpicGamesInventoryOK) Error() string {
	return fmt.Sprintf("[PUT /platform/public/namespaces/{namespace}/users/{userId}/iap/epicgames/sync][%d] syncEpicGamesInventoryOK  %+v", 200, o.ToString())
}

func (o *SyncEpicGamesInventoryOK) ToString() string {
