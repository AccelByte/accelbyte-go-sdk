...
func init() {
	...
	GdprCmd.AddCommand(platformAccountClosureClient.AdminGetPlatformAccountClosureClientsCmd)
	GdprCmd.AddCommand(platformAccountClosureClient.AdminValidateXboxBPCertFileCmd)
	...
	GdprCmd.AddCommand(platformAccountClosureClient.AdminMockPlatformAccountClosureDataCmd)
