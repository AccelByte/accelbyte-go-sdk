...
func (o *ExistsAnyUserActiveEntitlementOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/ownership/any][%d] existsAnyUserActiveEntitlementOK  %+v", 200, o.ToString())
}

func (o *ExistsAnyUserActiveEntitlementOK) ToString() string {
