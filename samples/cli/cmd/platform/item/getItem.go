...
func init() {
	...
	getItemCmd.Flags().StringP("itemId", "i", " ", "Item id")
	_ = getItemCmd.MarkFlagRequired("itemId")
	getItemCmd.Flags().StringP("namespace", "n", " ", "Namespace")
	_ = getItemCmd.MarkFlagRequired("namespace")
	getItemCmd.Flags().BoolP("activeOnly", "a", false, "Active only")
	getItemCmd.Flags().StringP("storeId", "s", " ", "Store id")
}
