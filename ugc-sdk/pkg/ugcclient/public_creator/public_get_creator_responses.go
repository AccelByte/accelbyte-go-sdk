...
func (o *PublicGetCreatorOK) Error() string {
	return fmt.Sprintf("[GET /ugc/v1/public/namespaces/{namespace}/users/{userId}][%d] publicGetCreatorOK  %+v", 200, o.Payload)
}
...
func (o *PublicGetCreatorUnauthorized) Error() string {
	return fmt.Sprintf("[GET /ugc/v1/public/namespaces/{namespace}/users/{userId}][%d] publicGetCreatorUnauthorized  %+v", 401, o.Payload)
}
...
func (o *PublicGetCreatorNotFound) Error() string {
	return fmt.Sprintf("[GET /ugc/v1/public/namespaces/{namespace}/users/{userId}][%d] publicGetCreatorNotFound  %+v", 404, o.Payload)
}
...
func (o *PublicGetCreatorInternalServerError) Error() string {
	return fmt.Sprintf("[GET /ugc/v1/public/namespaces/{namespace}/users/{userId}][%d] publicGetCreatorInternalServerError  %+v", 500, o.Payload)
}
