...
func (o *DeleteGroupAdminV1BadRequest) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/admin/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupAdminV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteGroupAdminV1Unauthorized) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/admin/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupAdminV1Unauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteGroupAdminV1Forbidden) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/admin/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupAdminV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteGroupAdminV1NotFound) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/admin/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupAdminV1NotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteGroupAdminV1InternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /group/v1/admin/namespaces/{namespace}/groups/{groupId}][%d] deleteGroupAdminV1InternalServerError  %+v", 500, o.Payload)
}
